...
import com.ramazzotte.validation.transtorno.TranstornoInsert;

@TranstornoInsert
public class TranstornoNewDTO {
	private Integer id;
	private String nome;
	private String cid;
	...
	public TranstornoNewDTO(Integer id, String nome, String cid, String maisInfo, String pagLivro,
