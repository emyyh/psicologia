...
import com.ramazzotte.validation.criterios.CriteriosInsert;

@CriteriosInsert
public class CriteriosNewDTO {
	private Integer id;
	...
	public CriteriosNewDTO (Integer id, Transtorno transtono, String nome, String descricao, OffsetDateTime dtcadastro,
